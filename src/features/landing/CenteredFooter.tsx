...
const CenteredFooter = (props: {
  ...
  return (
    <div className="flex flex-col items-center text-center">
      ...
      <ul className="mt-6 flex flex-row gap-x-6 text-muted-foreground [&_svg:hover]:text-primary [&_svg:hover]:opacity-100 [&_svg]:size-8 [&_svg]:fill-current [&_svg]:opacity-60">
  {props.iconList}
</ul>
